					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in" id="fininscripcion">
							...
							<?php
								if (isset($_GET['mp'])) {
									$medioPago = $_GET['mp'];
									if ($medioPago == 2 || $medioPago == 4) {//Mercado Pago o Todo Pago
										include_once 'templates/inscripcion-pago-realizado-ok.php';
									} else if ($medioPago == 5) {//Transferencia Bancaria
										include_once 'templates/otros-pago.php';
									}
									/*if ($medioPago == 1) {
										include_once 'templates/inscripcion-paso3-exito.php';
									} else if ($medioPago == 2 || $medioPago == 3) {
										include_once 'templates/avisar-pago.php';
									} else {
										include_once 'templates/otros-pago.php';
									}*/
								} else {
									// Si es docente no paga la inscripcion
									include_once 'templates/inscripcion-docente-ok.php';
								}
							?>
								</div>
							</div>
